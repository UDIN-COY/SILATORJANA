      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4">
        <Card className="shadow-sm border-slate-200">
          <CardContent className="p-4 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
            <div className="p-2 sm:p-3 rounded-full bg-blue-100 text-blue-600 shrink-0">
               <ShieldAlert className="size-4 sm:size-6" />
            </div>
            <div>
               <p className="text-[11px] sm:text-sm font-medium text-slate-500 leading-tight">Perlu Persetujuan</p>
        ...
        <Card className="shadow-sm border-slate-200">
          <CardContent className="p-4 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
            ...
            <div>
               <p className="text-[11px] sm:text-sm font-medium text-slate-500 leading-tight">Telah Disetujui</p>
               <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mt-1">{disetujui.length}</h3>
            </div>
          </CardContent>
        </Card>
      </div>
