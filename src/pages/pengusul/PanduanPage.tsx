    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <Card className="shadow-sm border-slate-200 overflow-hidden">
        <CardHeader className="bg-emerald-50/50 border-b border-emerald-100">
          <CardTitle className="text-base text-emerald-800">Langkah-langkah Pengajuan Proposal (Geser)</CardTitle>
        </CardHeader>
        <CardContent className="p-0">
          <div ref={scrollRef} className="flex overflow-x-auto snap-x snap-mandatory hide-scrollbar select-none">
            {GUIDE_STEPS.map((step, idx) => (
              <div key={idx} className="shrink-0 w-[85vw] sm:w-[280px] snap-center p-6 border-r border-slate-100 last:border-r-0">
                <div className="size-10 rounded-xl bg-emerald-100 flex items-center justify-center shrink-0 border-2 border-white shadow-sm mb-4">
